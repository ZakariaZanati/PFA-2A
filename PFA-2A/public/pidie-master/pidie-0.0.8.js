...
class Pidie {
  ...
  countries() {
    return [
      ...
      { id: 'MA', name: 'MAROC', currency_code: 'MAD', currency_name: 'Dirham', phone: '+212', language_code: 'ar', language_name: 'العربية', demonym: 'Marocain' }
    ];
  }
  ...
  telephoneInput() {
    ...
    Array.prototype.forEach.call(document.querySelectorAll('.pd-telephone-input'), function(elem){
      ...
      var dropdownContent = '';
      dropdownContent += '<div class="pd-telephone-flag"><div class="flag flag-ma"></div></div><ul class="pd-telephone-list"></ul>';
  ...
  flagSelectBox() {
    ...
    Array.prototype.forEach.call(document.querySelectorAll('.pd-countries'), function(elem){
      var addCountry = '';
      addCountry += '<option data-value="hello" value="">Choisir une Pays:</option>';
      flagCountry.forEach(function(res){
        addCountry += '<option data-value="'+res.id+'" value="'+res.name+'">'+res.name+'</option>';
      })
